                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldotoko WHERE toko_id='$_SESSION[toko_id]' ORDER BY saldotoko_created DESC LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldotoko WHERE toko_id='$_SESSION[toko_id]'"));
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/assets/images/saldo/<?php echo $r['saldotoko_photo'] ?>" target="_blank">
                                                        <img style="width: 100px" src="admin/assets/images/saldo/<?php echo $r['saldotoko_photo'] ?>">
                                                    </a>
                                                </td>
                                                <td>
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldotoko WHERE toko_id='$_SESSION[toko_id]' WHERE saldotoko_name LIKE '%$search%' AND saldotoko_status='process' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldotoko WHERE toko_id='$_SESSION[toko_id]' WHERE saldotoko_name LIKE '%$search%' AND saldotoko_status='process'"));
                                            if(mysqli_num_rows($result) === 0) {
                                    ?>
                                            <tr>
