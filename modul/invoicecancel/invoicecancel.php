<?php
 if (empty($_SESSION['pelanggan_username']) AND empty($_SESSION['pelanggan_password'])){
    ...
    $action="modul/invoicecancel/action.php?module=".$_GET['module']."&act=".$_GET['act'];
    switch($_GET['act']) {
        default:
        ?>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND pelanggan_username='$_SESSION[pelanggan_username]' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM invoice WHERE invoice_status='cancel' AND pelanggan_username='$_SESSION[pelanggan_username]'"));
                                            ...
                                            <tr>
                                              ...
                                              Per Toko : <?php echo format_rupiah($r['invoice_ongkir']/$r['invoice_totaltoko']); ?>
                                                ...
                                                <td class="text-center action">
                                                    <a style="margin-bottom: 10px" class="btn btn-primary" href="?module=invoicecancel&act=detail&id=<?php echo $r['invoice_id'];?>">
                                                        Detail
                                                    </a>
                                                </td>
                                                <?php $no++; } ?>
            ...
            <div class="page-content container-fluid">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body container-fluid">
                            ...
                            <div class="form-group form-material">
                                ...
                                <input type="text" class="form-control input-sm" id="invoice_cancel" name="invoice_cancel" placeholder="Masukan Alasan Pesanan di Cancel"
                                    value="" required/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class='button text-center'>
                        ...
                        <a class="btn btn-default btn-sm" href="?module=invoicecancel">Kembali</a>
                    </div>
                </div>
            </div>
        </form>
