                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM menu WHERE toko_id='$_SESSION[toko_id]' ORDER BY menu_created DESC LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM menu WHERE toko_id='$_SESSION[toko_id]'"));
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/assets/images/menu/<?php echo $r['menu_photo'] ?>" target="_blank">
                                                        <img style="width: 100px" src="admin/assets/images/menu/<?php echo $r['menu_photo'] ?>">
                                                    </a>
                                                </td>
                                                <td>
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM menu WHERE menu_name LIKE '%$search%' AND toko_id='$_SESSION[toko_id]' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM menu WHERE menu_name LIKE '%$search%' AND toko_id='$_SESSION[toko_id]'"));
                                            if(mysqli_num_rows($result) === 0) {
                                    ?>
                                            <tr>
                ...
                <div class="col-md-6">
                    <div class="panel">
                        ...
                        <div class="panel-body container-fluid">
                                <input type="hidden" class="form-control input-sm" id="toko_id" name="toko_id" placeholder="Masukan Nama" readonly value="<?php echo $_SESSION['toko_id'] ?>" required/>
                                        ...
                                        <table class="table table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="admin/assets/images/menu/<?php echo $p['menu_photo'] ?>" target="_blank">
                                                            <img style="width: 100px" src="admin/assets/images/menu/<?php echo $p['menu_photo'] ?>">
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
