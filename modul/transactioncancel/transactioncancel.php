                                ...
                                <form method="get" action='<?php echo $_SERVER[' PHP_SELF '] ?>'>
                                    ...
                                    <div class='btn-navigation'>
                                        <div class='pull-right'>
                                            <a class="btn btn-primary" href="?module=transactioncancel">
                                            ...
                                            <tr>
                                               ...
                                               Ongkos Kirim : <?php echo format_rupiah($r['invoice_ongkir']/$r['invoice_totaltoko']); ?> 
                                                ...
                                                <?php if ($r['invoice_statustoko'] == 'processaccept') { ?>
                                                    <a class="btn-update" href="?module=transactioncancel&act=processaccept&id=<?php echo $r['invoice_id'];?>&toko=<?php echo $toko['toko_id'];?>" data-id="<?php echo $r['invoice_id'];?>" 
                                                        title="">
                                                        <i class="icon wb-check"></i>
                                                    </a>
                                                    <?php } else if ($r['invoice_statustoko'] == 'selectdriveraccept') { ?>
                                                        <a class="btn-update" href="?module=transactioncancel&act=selectdriveraccept&id=<?php echo $r['invoice_id'];?>&toko=<?php echo $toko['toko_id'];?>" data-id="<?php echo $r['invoice_id'];?>" 
                                                        title="">
                                                        <i class="icon wb-users"></i>
                                                    </a>
                                                 <?php } ?>
                                                    <a class="btn-detail" href="?module=transactioncancel&act=detail&id=<?php echo $r['invoice_id'];?>">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="col-md-12">
                    <div class='button text-center'>
                        ...
                        <a class="btn btn-default btn-sm" href="?module=transactioncancel">Kembali</a>
                    </div>
                </div>
            </div>
        </form>
