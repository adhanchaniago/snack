                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='process' AND pelanggan_username='$_SESSION[pelanggan_username]' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM invoice WHERE invoice_status='process' AND pelanggan_username='$_SESSION[pelanggan_username]'"));
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center action">
                                                    <a style="margin-bottom: 10px" class="btn btn-primary" href="?module=invoiceprocess&act=detail&id=<?php echo $r['invoice_id'];?>">
                                                        Detail
                                                    </a>
                                                    <?php if (!$r['invoice_photo']) { ?>
                                                    <a class="btn btn-success" href="?module=invoiceprocess&act=upload&id=<?php echo $r['invoice_id'];?>">
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_id LIKE '%$search%' AND invoice_status='process' LIMIT $posisi,$batas");
        ...
        <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="exampleStandardForm" autocomplete="off">
            <div class="page-content container-fluid">
                ...
                <div class="col-md-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h5 class="panel-title">Konfirmasi Pemesanan #
                ...
                <div class="col-md-12">
                    <div class='button text-center'>
                        <input class="btn btn-primary btn-sm" type="submit" name="simpan" value="Konfirmasi Pesanan" id="validateButton2">
