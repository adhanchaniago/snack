f<?php
 if (empty($_SESSION['pelanggan_username']) AND empty($_SESSION['pelanggan_password'])){
    ...
    $action="modul/saldodone/action.php?module=".$_GET['module']."&act=".$_GET['act'];
    switch($_GET['act']) {
        default:
        ?>
                                ...
                                <form method="get" action='<?php echo $_SERVER[' PHP_SELF '] ?>'>
                                    <div class='btn-navigation'>
                                        <div class='pull-right'>
                                            <a class="btn btn-primary" href="?module=saldodone">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldo WHERE saldo_status='done' AND pelanggan_username='$_SESSION[pelanggan_username]' ORDER BY saldo_created DESC LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldo WHERE saldo_status='done' AND pelanggan_username='$_SESSION[pelanggan_username]'"));
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Rp<?php echo format_rupiah($saldo_price);?>,00
                                                </td>
                                                <td>
                                                    <?php echo $tanggal?>
                                                </td>
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldo WHERE saldo_name LIKE '%$search%' AND saldo_status='done' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldo WHERE saldo_name LIKE '%$search%' AND saldo_status='done'"));
                                            if(mysqli_num_rows($result) === 0) {
                                    ?>
                                            <tr>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="col-md-12">
                    <div class='button text-center'>
                        ...
                        <a class="btn btn-default btn-sm" href="?module=saldodone">Kembali</a>
                    </div>
                </div>
            </div>
        </form>
