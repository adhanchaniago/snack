                            ...
                            <div class="navigation-btn">
                                <form method="get" action='<?php echo $_SERVER[' PHP_SELF '] ?>'>
                                    <div class='btn-navigation'>
                                        <a class="btn btn-primary" style="margin-right: 10px;" href="?module=saldodriver&act=add">
                                            Tambah Saldo - Driver
                                        </a>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldodriver ORDER BY saldodriver_created DESC LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldodriver"));
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="assets/images/saldo/<?php echo $r['saldodriver_photo'] ?>" target="_blank">
                                                        <img style="width: 100px" src="assets/images/saldo/<?php echo $r['saldodriver_photo'] ?>">
                                                    </a>
                                                </td>
                                                <td>
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldodriver WHERE saldodriver_name LIKE '%$search%' AND saldodriver_status='process' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldodriver WHERE saldodriver_name LIKE '%$search%' AND saldodriver_status='process'"));
                                            if(mysqli_num_rows($result) === 0) {
                                    ?>
                                            <tr>
