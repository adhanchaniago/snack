                            ...
                            <div class="navigation-btn">
                                <form method="get" action='<?php echo $_SERVER[' PHP_SELF '] ?>'>
                                    ...
                                    <div class='btn-navigation'>
                                        <a class="btn btn-primary" style="margin-right: 10px;" href="?module=toko&act=add">
                                            Tambah Toko
                                        </a>
                                        <div class='pull-right'>
                                            <a class="btn btn-primary" href="?module=toko">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM toko LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM toko"));
                                    ...
                                    ?>
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM toko WHERE toko_name LIKE '%$search%' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM toko WHERE toko_name LIKE '%$search%'"));
                                            if(mysqli_num_rows($result) === 0) {
                                    ?>
                                            <tr>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body container-fluid">
                            <div class="form-group form-material">
                                ...
                                <select type="text" class="form-control input-sm" id="pelanggan_username" name="pelanggan_username" placeholder="Masukan Pelanggan"
                                    value="" required/>
                                <?php 
                            ...
                            <input type="hidden" class="form-control input-sm" id="toko_id" name="toko_id" placeholder="Masukan ID" value="<?php echo $p['toko_id'] ?>" required/>
                                <div class="form-group form-material">
                                    ...
                                    <select type="text" class="form-control input-sm" id="pelanggan_username" name="pelanggan_username" placeholder="Masukan Pelanggan"
                                        value="" required/>
                                        <?php 
                                         $result=mysqli_query($connect,"SELECT * FROM pelanggan WHERE pelanggan_username='$p[pelanggan_username]'");
