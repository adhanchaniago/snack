            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h5 class="panel-title">Saldo - Selesai</h5>
                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty(isset($_GET['filter']))) {
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM saldo WHERE saldo_status='done' ORDER BY saldo_created DESC LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM saldo WHERE saldo_status='done'"));
