    ...
    if (empty($_SESSION['driver_username']) AND empty($_SESSION['driver_password'])){
        ...
        while ($w = mysqli_fetch_array($website)) { ?>
            <head>
                ...
                <link rel="stylesheet" href="../admin/assets/libs/formvalidation/formValidation.css">
                ...
                <!--[if lt IE 9]>
            <script src="../../../admin/../admin/assets/libs/html5shiv/html5shiv.min.js"></script>
            <![endif]-->

                <!--[if lt IE 10]>
            <script src="../../../admin/../admin/assets/libs/media-match/media.match.min.js"></script>
            <script src="../../../admin/../admin/assets/libs/respond/respond.min.js"></script>
            <![endif]-->
            ...
            <body>
                ...
                <script>
                    $('#modal-konfirmasi').on('show.bs.modal', function (event) {
                        ...
                        var id = div.data('id');
                        var modal = $(this);
                        modal.find('#delete-ongkir').attr("href", "modul/ongkir/action.php?module=ongkir&act=delete&id=" + id);
                        modal.find('#delete-category').attr("href", "modul/category/action.php?module=category&act=delete&id=" + id);
                        modal.find('#delete-pelanggan').attr("href", "modul/pelanggan/action.php?module=pelanggan&act=delete&id=" + id);
                        modal.find('#delete-toko').attr("href", "modul/toko/action.php?module=toko&act=delete&id=" + id);
                        modal.find('#delete-ongkoskirim').attr("href", "modul/ongkoskirim/action.php?module=ongkoskirim&act=delete&id=" + id);
                        modal.find('#delete-menu').attr("href", "modul/menu/action.php?module=menu&act=delete&id=" + id);
                        modal.find('#delete-bank').attr("href", "modul/bank/action.php?module=bank&act=delete&id=" + id);
                        modal.find('#accept-invoice').attr("href", "modul/invoiceprocess/action.php?module=invoiceprocess&act=accept&id=" + id);
                        modal.find('#accept2-invoice').attr("href", "modul/invoiceprocess/action.php?module=invoiceprocess&act=accept2&id=" + id);
                    });
                </script>
                ...
                <script src="../admin/assets/libs/formvalidation/formValidation.min.js"></script>
                <script src="../admin/assets/libs/formvalidation/framework/bootstrap.min.js"></script>
                <!-- Scripts -->
