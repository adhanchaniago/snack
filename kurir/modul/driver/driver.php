<?php
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h5 class="panel-title">Data Pribadi Anda</h5>
                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $result=mysqli_query($connect,"SELECT * FROM driver WHERE driver_username='$_SESSION[driver_username]' LIMIT $posisi,$batas");
                                            $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM driver WHERE driver_username='$_SESSION[driver_username]'"));
    ...
    <?php
        ...
        break;
        case "edit":
        $result = mysqli_query($connect, "SELECT * FROM driver WHERE driver_username='$_SESSION[driver_username]'");
        ...
        break;
        case "editpassword":
        $result = mysqli_query($connect, "SELECT * FROM driver WHERE driver_username='$_SESSION[driver_username]' WHERE driver_username='$_GET[id]'");
        $p      = mysqli_fetch_array($result);
        ?>
                ?>
                <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="exampleStandardForm" autocomplete="off">
