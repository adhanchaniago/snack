                    ...
                    <div class="panel-body container-fluid table-detail">
                        <div class="table-full table-view">
                            ...
                            <table class="table table-hover">
                                ...
                                $result=mysqli_query($connect,"SELECT * FROM transaction WHERE transaction_status='process' AND driver_username='$_SESSION[driver_username]'");
                                $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM transaction WHERE transaction_status='process' AND driver_username='$_SESSION[driver_username]'"));
...
?>
                                        ...
                                        <?php echo $driver['driver_notelp']; ?>
                                            ...
                                            <?php if ($r['transaction_statustoko'] == 'selectdriveracceptdriver') { ?>
                                                <a class="btn-update" href="javascript:;" data-id="<?php echo $r['transaction_id'];?>" data-toggle="modal" data-target="#modal-konfirmasi"
                                                        title="">
                                            ...
                                            <?php } else if ($r['transaction_statustoko'] == 'drivertopelanggan') { ?>
                                                <a class="btn btn-primary" href="modul/invoiceprocess/action.php?module=invoiceprocess&act=driver&id=<?php echo $r['transaction_id'];?>"
                                                        title="">
                                                     Barang sudah sampai
                                                    </a>
                                            <?php }else { ?>
                                        ...
                                        $result=mysqli_query($connect,"SELECT * FROM transaction WHERE invoice_id LIKE '%$search%' AND  transaction_status='process' AND driver_username='$_SESSION[driver_username]'");
                                        $jmldata = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM transaction WHERE invoice_id LIKE '%$search%' AND  transaction_status='process' AND driver_username='$_SESSION[driver_username]'"));
                                        if(mysqli_num_rows($result) === 0) {
                                ?>
                                                <tr>
                                                    <td class="text-center" colspan="15">Data kosong...</td>
